...
.commit-hint { font-size: 0.85em; color: var(--vscode-descriptionForeground); margin-top: 5px; min-height: 15px; text-align: center; }
...
.file-status-indicator { width: 16px; text-align: center; font-weight: 700; font-size: 0.85em; flex-shrink: 0; margin-left: 4px; }
...
.conflict-banner-text { font-size: inherit; font-weight: 600; color: var(--vscode-foreground); white-space: nowrap; }
.conflict-banner-actions { display: flex; gap: 4px; flex-shrink: 0; }
.banner-btn { padding: 2px 10px; border: none; border-radius: 3px; font-size: 0.85em; cursor: pointer; background: var(--vscode-button-background); color: var(--vscode-button-foreground); }
...
.stash-label { font-size: 0.85em; color: var(--vscode-descriptionForeground); white-space: nowrap; flex-shrink: 0; margin-right: 4px; }
.stash-file-row { padding-left: 38px !important; cursor: pointer; }
.stash-loading { padding: 4px 8px 4px 38px; font-size: 0.85em; color: var(--vscode-descriptionForeground); }
`;
